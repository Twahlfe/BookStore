...
namespace a1_bookstore_ict715.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Name,GenreName,Description,Authors,Price,PublishDate")] BookModel bookModel)
        {
            ...
            ViewData["GenreName"] = new SelectList(_context.Genre, "GenreName", "GenreName", bookModel.GenreName);
            return View(bookModel);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Name,GenreName,Description,Authors,Price,PublishDate")] BookModel bookModel)
        {
